...
en caso de error por conexión puede deberse que la base de datos esta apagada, contactar con los integrantes del equipo para poder levantar el servicio de base de datos
**DEPRECADO**
